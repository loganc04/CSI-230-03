function ChooseTimeToRun($Time) {
    ...
    $action = New-ScheduledTaskAction -Execute "powershell.exe" -argument "-File `"c:\Users\champuser\Desktop\CSI-230\week7\main.ps1`""
...
function DisableAutoRun(){
    $scheduledTasks = Get-ScheduledTask | Where-Object {$_.TaskNice -ilike "myTask"}
